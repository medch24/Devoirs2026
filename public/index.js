document.addEventListener('DOMContentLoaded', () => {
    ...
    // CORRECTION : Les dates de naissance sont au format Mois/Année (M/YYYY) comme vous l'avez demandé.
    const studentData = {
        PEI1: [
    ...
    // ... (Le reste des fonctions est complet et correct)
