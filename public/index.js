document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadStudentDashboard(className, studentName, date) {
        ...
        try {
            // CORRECTION FINALE : Toujours envoyer la date en format universel
