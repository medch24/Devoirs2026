document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('teacher-login-form').addEventListener('submit', async (e) => {
        ...
        if (isAdmin) {
            ...
            await setupTeacherDashboard(false);
            showView('teacher-dashboard-view');
        } else {
